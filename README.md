...
<ol>
  ...
  Рекомендовано исследовать причины отписок и причины снижения количества новых подписчиков, так как траты на маркетинг не уменьшились
  <li>Итог №2</li>
  
-исследовать причины отписок и причины снижения количества новых подписчиков
-увеличивать базу фильмов для продления сроков «жизни» клиентов
